...
public class WallColorChange1pikachu : MonoBehaviour
{
    private Material wallMaterial;
    private Color originalColor;
    private Color collisionColor = Color.yellow; // Change this to your desired color
    ...
    private void Start()
    {
        ...
        pikachuObject = GameObject.FindGameObjectWithTag("pikachu");
